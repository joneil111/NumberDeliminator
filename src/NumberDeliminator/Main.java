 ...
 *
 * This program will take any list of numbers and sort them in accending order and display a summarized form to the user
 * It will display a range when the numbers are sequential by using a "-" to seperate them
 ...
 * ie.  as long as integer values are seperated in the input list by a "," it will work reguardless of spacing issues
